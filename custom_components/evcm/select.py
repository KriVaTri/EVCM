...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    async_add_entities([
        _PhaseSwitchModeSelect(controller, entry.entry_id, friendly_name=f"{base} Phase switching mode", object_id=object_id)
    ])
...
class _PhaseSwitchModeSelect(SelectEntity):
    ...
    def __init__(self, controller: EVLoadController, entry_id: str, friendly_name: str, object_id: str) -> None:
        ...
        self._attr_unique_id = f"{DOMAIN}_{entry_id}_phase_switch_mode"
